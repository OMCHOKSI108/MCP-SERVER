...
Generated on: 2025-11-23 19:12:10
...
![Sentiment Distribution](sentiment_distribution_20251123_191210.png)

## Customer Segmentation Analysis
Customers have been segmented into 3 distinct groups using K-Means clustering on rating and sentiment scores.

### Cluster Profiles
#### Cluster 0.0 (106875 customers)
- **Profile**: This cluster represents highly dissatisfied customers with strongly negative sentiment. These are frustrated users who are likely to churn and spread negative word-of-mouth.
- **Average Rating**: 1.08/5
- **Average Sentiment Score**: -0.548
- **Strategic Focus**: Prioritize immediate attention to address their concerns and prevent reputation damage.

#### Cluster 1.0 (191309 customers)
...
- **Average Sentiment Score**: 0.758
- **Strategic Focus**: Conduct deeper analysis of this segment to understand their unique needs.

#### Cluster 2.0 (101815 customers)
- **Profile**: This cluster shows mixed satisfaction levels requiring further analysis. These customers have varied experiences that don't fit clear patterns.
- **Average Rating**: 1.00/5
- **Average Sentiment Score**: 0.622
- **Strategic Focus**: Conduct deeper analysis of this segment to understand their unique needs.

![Cluster Distribution](cluster_distribution_20251123_191210.png)

![Cluster Scatter Plot](cluster_scatter_20251123_191210.png)
...
- Critical attention needed for Clusters cluster_0.0 (representing 0 customers) which combine low ratings with strongly negative sentiment - these dissatisfied segments are at high risk of churn.
- Clusters cluster_1.0, cluster_2.0 show disconnect between numerical ratings and sentiment scores, suggesting customers may be rating specific aspects while expressing broader frustrations in reviews.
